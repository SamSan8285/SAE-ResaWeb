...
if (isset($_GET['film'])) {
    ...
    $genres = $filmDetails['genres'] ?? 'Non spécifié';
    $realisateur_nom = $filmDetails['realisateur_nom'] ?? 'Non spécifié';
    $realisateur_prenom = $filmDetails['realisateur_prenom'] ?? 'Non spécifié';
    ...
    <div class="container-info">
        ...
        <div class="all-info">   
            ...
            <div class="info-right">
                ...
                <a class="separateur-film"><?php echo htmlspecialchars(convertDurationToHours($duree)); ?> | Genre: <?php echo htmlspecialchars($genres); ?><br>
                Par le Réalisateur <?php echo htmlspecialchars($realisateur_nom) . ' ' . htmlspecialchars($realisateur_prenom); ?></a>
